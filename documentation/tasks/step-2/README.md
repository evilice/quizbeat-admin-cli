...
|---|--------|------------|------|--------|
| 1 | Стор сотрудников: список, создание, правка, деактивация, сброс пароля | этап 1 (клиент с access и разбор ошибки) | [01-admins-store.md](./01-admins-store.md) | выполнена |
| 2 | Список вместо заглушки: поиск, фильтры, пагинация, отказ `403` | 1 | [02-admins-list.md](./02-admins-list.md) | выполнена |
| 3 | Создание сотрудника | 2 | [03-create-admin.md](./03-create-admin.md) | выполнена |
| 4 | Смена роли, деактивация и повторная активация | 2 | [04-role-and-activity.md](./04-role-and-activity.md) | выполнена |
| 5 | Сброс пароля другого сотрудника | 2 | [05-reset-password.md](./05-reset-password.md) | выполнена |
| 6 | Приёмка этапа 2 целиком | 3, 4, 5 | [06-step2-acceptance.md](./06-step2-acceptance.md) | не выполнена |
