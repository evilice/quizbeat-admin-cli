...
|---|--------|------------|------|--------|
| 1 | Стор тегов: список, создание, правка, удаление | этап 1 (клиент с access и разбор ошибки) | [01-tags-store.md](./01-tags-store.md) | не выполнена |
| 2 | Список и пункт меню: поиск, пагинация, оба названия | 1 | [02-tags-list.md](./02-tags-list.md) | не выполнена |
| 3 | Создание и правка: код и оба перевода | 2 | [03-tag-form.md](./03-tag-form.md) | не выполнена |
| 4 | Удаление тега с подтверждением | 2 | [04-delete-tag.md](./04-delete-tag.md) | не выполнена |
| 5 | Приёмка этапа 3 целиком | 3, 4 | [05-step3-acceptance.md](./05-step3-acceptance.md) | не выполнена |
