...
|---|--------|------------|------|--------|
| 1 | Правило обновления блоков после мутаций (без смешения `fileUrl`) | этап 4 (карточка и `GET .../full`), этапы 5–7 (блоки мутаций) | [01-post-mutation-refresh.md](./01-post-mutation-refresh.md) | не выполнена |
| 2 | Приёмка этапа 8 целиком | 1 | [02-step8-acceptance.md](./02-step8-acceptance.md) | не выполнена |
