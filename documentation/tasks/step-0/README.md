...
|---|--------|------------|------|
| 1 | Каркас Vite, скрипты, порт 5173, `VITE_API_BASE_URL` | — | [01-project-scaffold.md](./01-project-scaffold.md) |
| 2 | HTTP-клиент и разбор тела ошибки | 1 | [02-http-client.md](./02-http-client.md) |
| 3 | Оболочка: тема MUI `ruRU`, MobX, маршрут-заглушка | 1 | [03-app-shell.md](./03-app-shell.md) |
| 4 | Приёмка этапа 0 целиком | 2, 3 | [04-step0-acceptance.md](./04-step0-acceptance.md) |
